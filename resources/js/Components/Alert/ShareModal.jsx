    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 p-5 ">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm md:max-w-2xl flex flex-col items-center justify-center py-20 px-10">
                {/* Judul */}
                <h2 className="text-lg md:text-2xl font-semibold text-primary-100 mb-4">
                    Share your link
                </h2>
                ...
                >
                    <Icon
                        icon="mdi:whatsapp"
                        className="text-4xl md:text-6xl text-primary-100"
                    />
                </a>

                {/* Garis OR */}
                <div className="flex w-3/4 md:w-3/5 items-center gap-4 text-gray-500 mb-4">
                    <hr className="flex-1 border-t border-foreground" />
                    <span className="text-md md:text-xl text-primary-100">
                        OR
                    </span>
                    <hr className="flex-1 border-t border-foreground" />
                </div>
                ...
                <div className=" w-[80%] md:w-[60%] ">
                        <div className="rounded-2xl px-4 py-3 flex items-center justify-between mb-4 gap-2 border border-brfourth bg-white overflow-hidden">
